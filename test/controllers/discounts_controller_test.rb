...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { DiscountType_id: @discount.DiscountType_id, amount: @discount.amount, category_id: @discount.category_id, end: @discount.end, name: @discount.name, start: @discount.start } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { DiscountType_id: @discount.DiscountType_id, amount: @discount.amount, category_id: @discount.category_id, end: @discount.end, name: @discount.name, start: @discount.start } }
